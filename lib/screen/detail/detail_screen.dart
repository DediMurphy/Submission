...
import 'package:restaurantapp/screen/detail/body_of_detail_screen_widget.dart';
import 'package:restaurantapp/screen/detail/favorite_icon_widget.dart';
  ...
  void initState() {
    ...
    Future.microtask(() {
      context
          ...
          .fetchRestourantDetail(widget.restaurantId);
    });
  }
